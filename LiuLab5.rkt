...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname LiuLab5) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
;no z-axis
(define manhattan-xy      
  (lambda (down right) 
